...
import { Terminal, Database, Target, Zap, ArrowRight, BarChart3, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="w-full bg-white text-gray-900 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20 mb-32">
        ...
        >
          <div>
            <span className="text-jc-teal font-bold tracking-wider uppercase text-sm mb-4 block">Our Technology</span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-[1.1] mb-6">
              World-class advertising technology to drive e-commerce sales
            </h1>
          ...
          <div className="space-y-6">
            <div className="bg-white border border-gray-200 p-6 rounded-2xl relative overflow-hidden group hover:border-jc-teal/40 hover:shadow-md transition-all">
               <div className="absolute top-0 right-0 w-32 h-32 bg-jc-teal/5 blur-[40px] rounded-full group-hover:bg-jc-mint/10 transition-colors" />
        ...
        >
          ...
          <div className="relative rounded-3xl bg-gray-900 border border-gray-700 p-4 shadow-xl aspect-square md:aspect-[4/3] flex flex-col hidden sm:flex">
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-16 lg:gap-20">
        ...
        >
          ...
          <div className="relative rounded-3xl overflow-hidden aspect-square border border-gray-200 shadow-md group bg-gray-50 flex items-center justify-center">
             <div className="absolute inset-0 bg-gradient-to-br from-jc-teal/5 to-transparent" />
             <div className="absolute inset-0 backdrop-blur-[2px]" />
             <Target className="w-32 h-32 text-jc-teal/10 absolute" />
             ...
             <motion.div 
                ...
                className="absolute bottom-8 left-8 right-8 bg-gray-900 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl"
             >
        ...
        >
           <div className="space-y-6">
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
                 Utilizing <span className="text-jc-teal">dynamic CPM (dCPM)</span>
              </h2>
           ...
           <div className="space-y-4 pt-4">
              <button className="w-full sm:w-auto px-10 py-5 bg-gray-900 hover:bg-gray-800 text-white font-bold rounded-xl transition-all border border-gray-800 shadow-lg text-lg flex justify-center items-center gap-2">
                 Book a Meeting
              </button>
              
              <div className="text-center sm:text-left py-4">
                 <span className="text-gray-500 font-medium text-sm tracking-wider uppercase">Get Started with</span>
              </div>
