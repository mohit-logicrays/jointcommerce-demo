      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center">
            <Link to="/contact" className="px-6 py-2.5 rounded-full border border-jc-teal text-jc-teal hover:bg-jc-teal hover:text-white transition-colors text-sm font-bold shadow-sm inline-block">
              Contact Us
            </Link>
          </div>
          ...
          >
            <div className="px-4 py-6 space-y-2 max-h-[80vh] overflow-y-auto">
              ...
              <div className="pt-6 pb-2 px-3">
                <Link to="/contact" onClick={handleMobileNavClick} className="w-full px-6 py-4 rounded-full border-2 border-jc-teal font-bold bg-jc-teal text-white transition-colors shadow-md text-lg block text-center">
                  Contact Us
                </Link>
              </div>
            </div>
