...
const Background2 = () => (
  <div className="w-full h-full flex flex-col items-center justify-center relative overflow-hidden">
     ...
     <motion.div 
       className="text-red-300/40 font-mono text-[18px] md:text-[24px] tracking-widest break-all px-10 select-none text-center leading-loose font-bold"
       initial={{ opacity: 0 }}
       animate={{ opacity: 1 }}
     ...
     <motion.div className="absolute top-1/2 left-1/4 w-96 h-96 bg-red-400/5 rounded-full blur-[100px]" animate={{ opacity: [0.5, 0.8, 0.5] }} transition={{ duration: 4, repeat: Infinity }} />
  </div>
);
...
const Background3 = () => (
  <svg className="w-full h-full opacity-40" viewBox="0 0 1000 500" preserveAspectRatio="xMidYMid slice">
     ...
     <motion.g animate={{ y: [0, -15, 0], rotate: [0, 5, 0] }} transition={{ repeat: Infinity, duration: 4 }}>
        <rect x="150" y="200" width="100" height="60" rx="4" fill="#f3f4f6" stroke="#d1d5db" strokeWidth="2" transform="rotate(-15 150 200)" />
        <circle cx="200" cy="230" r="16" fill="#e5e7eb" />
     </motion.g>

     <motion.g animate={{ y: [0, 20, 0], rotate: [0, -5, 0] }} transition={{ repeat: Infinity, duration: 5, delay: 1 }}>
        <rect x="550" y="250" width="80" height="40" fill="#d1fae5" stroke="#059669" strokeWidth="2" transform="rotate(25 550 250)" />
     ...
     <motion.g animate={{ y: [0, -10, 0], rotate: [0, 8, 0] }} transition={{ repeat: Infinity, duration: 4.5, delay: 0.5 }}>
         <rect x="700" y="80" width="160" height="200" rx="6" fill="#f9fafb" stroke="#d1d5db" strokeWidth="3" transform="rotate(-5 700 80)" />
         <rect x="715" y="100" width="130" height="40" fill="#e5e7eb" />
         <text x="735" y="130" fill="#374151" fontSize="28" fontWeight="bold">$$$$$</text>
         <rect x="720" y="160" width="30" height="30" fill="#f3f4f6" />
         <rect x="760" y="160" width="30" height="30" fill="#f3f4f6" />
         <rect x="800" y="160" width="30" height="30" fill="#f3f4f6" />
         
         <rect x="720" y="200" width="30" height="30" fill="#f3f4f6" />
         <rect x="760" y="200" width="30" height="30" fill="#f3f4f6" />
         <rect x="800" y="200" width="30" height="30" fill="#f3f4f6" />
         
         <rect x="720" y="240" width="30" height="30" fill="#f3f4f6" />
         <rect x="760" y="240" width="30" height="30" fill="#f3f4f6" />
         <rect x="800" y="240" width="30" height="30" fill="#f3f4f6" />
     </motion.g>
  </svg>
);
...
export function Challenges() {
  ...
  return (
    <section className="pt-24 pb-8 md:pb-16 bg-gray-50 overflow-hidden relative border-y border-gray-200 font-sans min-h-[700px] flex flex-col">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
         ...
         <div className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-50/40 to-gray-50 pointer-events-none" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex flex-col justify-between w-full h-full">
        ...
        <div className="mb-20">
          <h2 className="text-3xl md:text-5xl lg:text-5xl font-extrabold tracking-tight">
             <span className="text-gray-900 px-3 py-1 leading-snug box-decoration-clone inline-block">
           ...
           {tabs.map((tab, i) => (
              ...
              >
                  ...
                  <AnimatePresence>
                     {activeTab === i && (
                        <motion.div 
                           ...
                           className="absolute bottom-[calc(100%+12px)] left-0 w-full min-w-[280px] bg-white border border-gray-200 rounded-xl p-6 shadow-xl z-50 pointer-events-auto"
                        >
                           <h3 className="text-lg font-bold text-gray-900 mb-4 whitespace-pre-line tracking-wide">
                              {tab.title}
                           </h3>
                           ...
                           <Link 
                              to="/solutions" 
                              className="inline-block w-full text-center px-4 py-3 border border-gray-200 rounded-lg hover:border-jc-teal hover:bg-jc-teal/5 hover:text-jc-teal transition-all text-gray-700 font-medium text-sm bg-transparent"
                           >
                              Discover More
                           </Link>
                        </motion.div>
                  ...
                  <div className={`w-full p-4 lg:p-6 border rounded-xl transition-all h-[100px] flex items-center ${
                     activeTab === i ? 'border-jc-teal/50 bg-white shadow-md' : 'border-gray-200 hover:border-gray-300 bg-white/70 backdrop-blur-sm'
                  }`}>
                     <h3 className={`font-semibold whitespace-pre-line text-sm lg:text-base transition-colors ${
                        activeTab === i ? 'text-gray-900' : 'text-gray-500'
                     }`}>
                        {tab.title}
                     </h3>
                  </div>
