  ...
  return (
    <div className="w-full bg-white text-gray-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
        ...
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Route activation traffic to:</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-200">
                ...
                <span className="text-lg font-medium text-gray-800">{route.title}</span>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Brand Programs</h2>
          
          <div className="space-y-6">
            <div className="border-l-2 border-jc-teal pl-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Retail Sell-Through Starter</h3>
              <p className="text-gray-600">Establish your presence and drive initial momentum at key retail partnerships.</p>
            </div>
            
            <div className="border-l-2 border-jc-teal pl-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Statewide Performance Activation</h3>
              <p className="text-gray-600">Scale your brand visibility across an entire state's legal marketplace.</p>
            </div>
            
            <div className="border-l-2 border-jc-teal pl-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">National Co-Op Deployment</h3>
              <p className="text-gray-600">Execute massive, coordinated campaigns in tandem with MSO partners.</p>
            </div>
          </div>
