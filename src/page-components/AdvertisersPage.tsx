...
export function AdvertisersPage() {
  return (
    <div className="w-full bg-white text-gray-900 min-h-screen">
      ...
      >
        <span className="text-jc-teal font-bold tracking-wider uppercase text-sm mb-4 block">For Advertisers</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="bg-white border border-gray-200 p-10 lg:p-14 rounded-3xl shadow-sm"
        >
           <h2 className="text-2xl font-bold text-gray-900 mb-6">Activation Attributes:</h2>
           <ul className="space-y-6">
              {[
                 ...
                 <li key={i} className="flex items-center gap-4 text-gray-800 font-medium text-lg">
                    <div className="w-10 h-10 rounded-full bg-jc-teal/10 flex items-center justify-center border border-jc-teal/20 flex-shrink-0">
        ...
        >
           <div className="flex items-start gap-4">
              ...
              <div>
                 <h3 className="text-2xl font-bold text-gray-900 mb-2">Ancillary Advertisers</h3>
           ...
           <div className="flex items-start gap-4">
              <CheckCircle2 className="w-8 h-8 text-jc-teal flex-shrink-0 mt-1" />
              <div>
                 <h3 className="text-2xl font-bold text-gray-900 mb-2">Performance-Driven</h3>
                 <p className="text-gray-600 leading-relaxed text-lg">
