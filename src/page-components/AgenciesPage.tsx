      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
         ...
         >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-gray-900 mb-6">
               Agency & Wholesale Activation
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
               Empower your clients with actionable, regulated discovery deployment designed for agency execution.
            </p>
            
            <div className="flex flex-col gap-6 mt-12 bg-gray-50 p-8 rounded-2xl border border-gray-200">
               <h3 className="text-gray-900 font-bold text-xl mb-2 flex items-center gap-3">
               ...
               <button className="self-start px-6 py-3 rounded-xl bg-white border border-gray-200 hover:bg-gray-100 text-gray-700 font-medium transition-colors flex items-center gap-2 shadow-sm">
         ...
         >
            {[
               ...
               <div key={i} className="flex gap-6 p-6 md:p-8 bg-white border border-gray-200 rounded-3xl hover:border-jc-teal/40 hover:shadow-md transition-all hover:-translate-y-1">
                  ...
                  <div>
                     ...
                     <p className="text-gray-600 text-lg leading-snug">{tier.desc}</p>
                  </div>
               </div>
            ))}
         </motion.div>
