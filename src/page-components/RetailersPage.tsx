    ...
    <div className="w-full bg-white text-gray-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
        ...
        <motion.div
          ...
          className="relative aspect-square rounded-[2rem] bg-gray-50 border border-gray-200 p-8 shadow-sm flex items-center justify-center overflow-hidden"
        >
          {/* Abstract Graphic */}
          <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-jc-teal/10 via-transparent to-transparent opacity-50 blur-2xl"></div>
          <div className="relative z-10 w-full max-w-sm space-y-4">
            {[
              ...
              <motion.div 
                ...
                className="flex items-center gap-4 bg-white backdrop-blur-md p-4 rounded-xl border border-gray-200 shadow-sm"
              >
      ...
      <div className="mt-20">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Retailer Activation Programs</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm text-center hover:border-jc-teal/50 hover:shadow-md transition-all"
            >
